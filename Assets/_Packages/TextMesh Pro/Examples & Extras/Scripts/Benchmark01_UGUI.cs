...
#pragma warning disable CS0234 // “ип или им€ пространства имен "UI" не существует в пространстве имен "UnityEngine" (возможно, отсутствует ссылка на сборку).
using UnityEngine.UI;
#pragma warning restore CS0234 // “ип или им€ пространства имен "UI" не существует в пространстве имен "UnityEngine" (возможно, отсутствует ссылка на сборку).
...
#pragma warning disable CS0246 // Ќе удалось найти тип или им€ пространства имен "TMP_FontAsset" (возможно, отсутствует директива using или ссылка на сборку).
        public TMP_FontAsset TMProFont;
#pragma warning restore CS0246 // Ќе удалось найти тип или им€ пространства имен "TMP_FontAsset" (возможно, отсутствует директива using или ссылка на сборку).
...
#pragma warning disable CS0246 // Ќе удалось найти тип или им€ пространства имен "Text" (возможно, отсутствует директива using или ссылка на сборку).
        private Text m_textMesh;
#pragma warning restore CS0246 // Ќе удалось найти тип или им€ пространства имен "Text" (возможно, отсутствует директива using или ссылка на сборку).
