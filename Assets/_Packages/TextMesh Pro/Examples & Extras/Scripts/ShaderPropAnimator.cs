...
#pragma warning disable CS0103 // Имя "ShaderUtilities" не существует в текущем контексте.
                m_Material.SetFloat(ShaderUtilities.ID_GlowPower, glowPower);
#pragma warning restore CS0103 // Имя "ShaderUtilities" не существует в текущем контексте.
