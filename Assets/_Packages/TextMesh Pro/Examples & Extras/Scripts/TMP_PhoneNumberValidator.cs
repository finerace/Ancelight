...
#pragma warning disable CS0115 // "TMP_PhoneNumberValidator.Validate(ref string, ref int, char)": не найден метод, пригодный для переопределения.
        public override char Validate(ref string text, ref int pos, char ch)
#pragma warning restore CS0115 // "TMP_PhoneNumberValidator.Validate(ref string, ref int, char)": не найден метод, пригодный для переопределения.
        {
