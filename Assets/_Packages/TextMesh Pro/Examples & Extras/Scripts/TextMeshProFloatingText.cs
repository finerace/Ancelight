...
#pragma warning disable CS1061 // "Vector3" не содержит определения "Compare", и не удалось найти доступный метод расширения "Compare", принимающий тип "Vector3" в качестве первого аргумента (возможно, пропущена директива using или ссылка на сборку).
#pragma warning disable CS1061 // "Quaternion" не содержит определения "Compare", и не удалось найти доступный метод расширения "Compare", принимающий тип "Quaternion" в качестве первого аргумента (возможно, пропущена директива using или ссылка на сборку).
...
#pragma warning restore CS1061 // "Quaternion" не содержит определения "Compare", и не удалось найти доступный метод расширения "Compare", принимающий тип "Quaternion" в качестве первого аргумента (возможно, пропущена директива using или ссылка на сборку).
#pragma warning restore CS1061 // "Vector3" не содержит определения "Compare", и не удалось найти доступный метод расширения "Compare", принимающий тип "Vector3" в качестве первого аргумента (возможно, пропущена директива using или ссылка на сборку).
