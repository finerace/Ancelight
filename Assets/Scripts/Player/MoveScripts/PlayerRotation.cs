...
public class PlayerRotation : MonoBehaviour
{
    ...
    private void Start()
    {
        //Лок курсора и назначение вспомогательных полей
    ...
    private void Update()
    {
        ...
        if (MouseX + MouseY != 0)
        {
            ...
            //Проверка на неправильное поворот камеры
            ...
            //Если всё хорошо прибавлять повороту камеры нужное значение
